...
class Dara extends StatefulWidget {
  const Dara({Key? key}) : super(key: key);

  @override
  State<Dara> createState() => _DaraState();
}

class _DaraState extends State<Dara> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text("DARA ANTİK KENTİ"),
        titleSpacing: 0.0,
        centerTitle: true,
        toolbarHeight: 60.0,
        toolbarOpacity: 0.8,
